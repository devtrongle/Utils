...
public class AreaCode {
    ...
    /**
     * Get the area code of the country with position
     * @param position position area
     * @return string area
     */
    public static String getAreaCodeWithPosition(int position){
        if(position < countryAreaCodes.length)
            return "+"+countryAreaCodes[position];
        else
            return "+1";
    }
}
